...
from qfluentwidgets import (PushButton, ComboBox, Dialog, MessageBox, ColorDialog, TeachingTip, TeachingTipTailPosition,
                            InfoBarIcon, Flyout, FlyoutView, TeachingTipView, FlyoutAnimationType, SubtitleLabel,
                            LineEdit, MessageBoxBase)
from .gallery_interface import GalleryInterface


class Select_Contour_Dialog_Interface(GalleryInterface):
    """ Dialog interface """
    def __init__(self, parent=None):
        super().__init__(
            title='Select tumor contour data',
            subtitle='Please select TUMOR contour data from the list.',
            parent=parent
        )
        self.setObjectName('Select_Contour_Dialog_Interface')
